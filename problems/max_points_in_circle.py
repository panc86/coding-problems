...
# 2: Given S = 'ABB', X = [1, -2, -2], Y = [1, -2, 2], the function should return 1. There are two points that can be included in the circle: ('B', -2, -2), ('B', -2, 2). The both have the same tag as ('A', 2, 2) and the same distance from coordinates (0, 0).

# 3: Given S = 'CCD', X = [1, -1, 2], Y = [1, -1, 2], the function should return 0. The points with tag 'C' have the same distance from coordinates (0, 0).
